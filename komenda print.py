...
#2. Wyświetl w/w teksty uzywajac jako separatora znaku ";"
...
#3. Korzystajac z jednego polecenia print wyświetl napis (bez podtekstzw!):
...
#5. Uwaga: W tym zadaniu nie uzywaj konkatenacji napiszw (laczenia napiszw). Uzyj tylko polecenia print!
#I like watching News at 18:00 on BBC .
print ("I like watching",Item,"at",Time,"on",ProgramName,".")

#6.  Zmień napis tak, aby kropka byla zaraz za  BBC. Nadal nie korzystamy z konkatenacji ale z pojedyńczego polecenia print.
